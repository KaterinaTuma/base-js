...
describe('calcAvg', () => {
  test('Unit test1', () => {
    ...
    expect(studentAvgGrades).toEqual(test1.expectedStudentAvgGrades);
  });

  test('Unit test2', () => {
    const test2 = testData.test2;
    const studentAvgGrades = calcAvgCrades(test2.arr);
    expect(studentAvgGrades).toEqual(test2.expectedStudentAvgGrades);
  });

  test('Unit test3', () => {
    const test3 = testData.test3;
    const studentAvgGrades = calcAvgCrades(test3.arr);
    expect(studentAvgGrades).toEqual(test3.expectedStudentAvgGrades);
  });
});
